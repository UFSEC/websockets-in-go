...
func wsHandler(w http.ResponseWriter, r *http.Request) {
    ...
    log.Println("Asking for data chan")
    newClient <- true
    log.Println("Waiting for data chan")
    updateOut := <-newUpdateChan
    log.Println("Got my data chan!")
